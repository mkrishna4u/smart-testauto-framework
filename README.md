...
This is **Configuration Driven Testing (CDT)** framework. Sample configurations are present here that can be used under ./test-config directory to configure your project environment: 
