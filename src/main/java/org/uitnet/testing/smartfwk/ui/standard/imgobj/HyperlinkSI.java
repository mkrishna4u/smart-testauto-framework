...
public class HyperlinkSI extends Hyperlink {
	...
	@Override
	public HyperlinkValidatorSI getValidator(SmartCucumberScenarioContext scenarioContext, Region region) {
	...
	@Override
	public HyperlinkSI updateLocatorParameterWithValue(String paramName, String paramValue) {
