...
public class CheckBoxSD extends CheckBox {
	...
	@Override
	public CheckBoxValidatorSD getValidator(SmartCucumberUiScenarioContext scenarioContext, Region region) {
	...
	@Override
	public CheckBoxSD updateLocatorParameterWithValue(AppConfig appConfig, String paramName, String paramValue) {
