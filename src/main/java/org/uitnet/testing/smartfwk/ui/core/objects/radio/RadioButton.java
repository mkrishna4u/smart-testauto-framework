...
public abstract class RadioButton extends UIObject {
	...
	public abstract RadioButtonValidator getValidator(SmartAppDriver appDriver, Region region);

	public abstract RadioButtonValidator getValidator(SmartCucumberUiScenarioContext scenarioContext, Region region);
}
