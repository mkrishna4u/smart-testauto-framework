...
public class ListBoxSD extends ListBox {
	...
	public ListBoxSD(String displayName) {
		super(LocatorType.DOM, displayName);
	}

	public ListBoxSD(String displayName, Map<String, Locator> platFormLocators) {
		super(LocatorType.DOM, displayName);
	...
	public ListBoxSD addPlatformLocatorForWebApp(PlatformType platform, WebBrowserType browserType, LocateBy locateBy,
			String locatorValue) {
	...
	@Override
	public ListBoxValidatorSD getValidator(SmartAppDriver appDriver, Region region) {
		return new ListBoxValidatorSD(appDriver, this, region);
	}

	@Override
	public ListBoxValidatorSD getValidator(SmartCucumberUiScenarioContext scenarioContext, Region region) {
	...
	@Override
	public ListBoxSD updateLocatorParameterWithValue(AppConfig appConfig, String paramName, String paramValue) {
		...
		return new ListBoxSD(newDisplayName, newPlatFormLocators);
	}
