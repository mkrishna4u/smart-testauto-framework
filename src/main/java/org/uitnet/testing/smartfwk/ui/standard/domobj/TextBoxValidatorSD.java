...
public class TextBoxValidatorSD extends TextBoxValidator {
	...
	@Override
	public TextBoxValidatorSD scrollElementOnViewport(ScrollbarSI scrollbar) {
	...
	@Override
	public TextBoxValidatorSD validateElementPresentWithinArea(AreaCoordinates coordinates,
			int maxIterationsToLocateElements) {
