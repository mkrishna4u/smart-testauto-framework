...
public class LabelSD extends Label {
	...
	public LabelSD(String displayName) {
		super(LocatorType.DOM, displayName);
	}

	public LabelSD(String displayName, Map<String, Locator> platFormLocators) {
		super(LocatorType.DOM, displayName);
	...
	public LabelSD addPlatformLocatorForWebApp(PlatformType platform, WebBrowserType browserType, LocateBy locateBy,
			String locatorValue) {
	...
	@Override
	public LabelValidatorSD getValidator(SmartAppDriver appDriver, Region region) {
		return new LabelValidatorSD(appDriver, this, region);
	}

	@Override
	public LabelValidatorSD getValidator(SmartCucumberUiScenarioContext scenarioContext, Region region) {
	...
	@Override
	public LabelSD updateLocatorParameterWithValue(AppConfig appConfig, String paramName, String paramValue) {
		...
		return new LabelSD(newDisplayName, newPlatFormLocators);
	}
