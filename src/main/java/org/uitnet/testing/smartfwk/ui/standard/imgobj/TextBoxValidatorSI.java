...
public class TextBoxValidatorSI extends TextBoxValidator {
	...
	@Override
	public TextBoxValidatorSI scrollElementOnViewport(ScrollbarSI scrollbar) {
		// TODO
		return this;
	}
	...
	@Override
	public TextBoxValidatorSI validateElementPresentWithinArea(AreaCoordinates coordinates,
			int maxIterationsToLocateElements) {
		Match match = findElement(maxIterationsToLocateElements);
		if(!(match.x >= coordinates.getX1() && match.y >= coordinates.getY1() &&  
			...
			Assert.fail("Element '" + textBoxObj.getDisplayName() + "' is not within the specified area [x1=" + coordinates.getX1() 
