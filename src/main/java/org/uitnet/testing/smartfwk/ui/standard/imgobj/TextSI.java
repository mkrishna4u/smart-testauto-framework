...
public class TextSI extends Text {
	...
	public TextSI(String displayName, String labelImg, ObjectLocation labelImgLocation) {
	...
	public TextSI addPlatformImageForNativeApp(PlatformType platform, String labelImg) {
	...
	@Override
	public TextValidatorSI getValidator(SmartAppDriver appDriver, Region region) {
		return new TextValidatorSI(appDriver, this, region);
	}

	@Override
	public TextValidatorSI getValidator(SmartCucumberScenarioContext scenarioContext, Region region) {
	...
	@Override
	public TextSI updateLocatorParameterWithValue(String paramName, String paramValue) {
