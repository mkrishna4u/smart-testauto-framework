 ...
 *
 */
public class ScrollbarSD extends Scrollbar {
	protected Map<String, Locator> platFormLocators = new HashMap<>();

	public ScrollbarSD(String displayName) {
		super(LocatorType.DOM, displayName);
	}

	public ScrollbarSD(String displayName, Map<String, Locator> platFormLocators) {
		super(LocatorType.DOM, displayName);
		this.platFormLocators = platFormLocators;
	}

	public ScrollbarSD(String displayName, String xpath) {
		super(LocatorType.DOM, displayName);
		platFormLocators.put(SmartConstants.DEFAULT_XPATH_LOCATOR, new Locator(LocateBy.Xpath, xpath));
	}

	public ScrollbarSD addPlatformLocatorForNativeApp(PlatformType platform, LocateBy locateBy, String locatorValue) {
		LocatorUtil.setPlatformLocatorForNativeApp(platFormLocators, platform, locateBy, locatorValue);
		return this;
	}

	public ScrollbarSD addPlatformLocatorForWebApp(PlatformType platform, WebBrowserType browserType, LocateBy locateBy,
			String locatorValue) {
	...
	@Override
	public ScrollbarValidatorSD getValidator(SmartAppDriver appDriver, Region region) {
		return new ScrollbarValidatorSD(appDriver, this, region);
	}
	
	@Override
	public ScrollbarValidatorSD getValidator(SmartCucumberScenarioContext scenarioContext, Region region) {
		return new ScrollbarValidatorSD(scenarioContext.getActiveAppDriver(), this, region);
	}
	...
	@Override
	public ScrollbarSD updateLocatorParameterWithValue(String paramName, String paramValue) {
		...
		return new ScrollbarSD(newDisplayName, newPlatFormLocators);
	}
