 ...
 *
 */
public class ScrollbarSI {
	// protected SmartAppDriver appDriver;
	protected ScrollbarSI parent;
	...
	public ScrollbarSI(HorizontalScrollbarSI hScrollbar, Region hScrollbarRegion, VerticalScrollbarSI vScrollbar,
	...
	public ScrollbarSI getParent() {
		return parent;
	}

	public ScrollbarSI setParent(ScrollbarSI parent) {
		this.parent = parent;
		return this;
	}
