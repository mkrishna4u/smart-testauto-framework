...
import org.uitnet.testing.smartfwk.ui.core.objects.radio.RadioButtonGroup;
...
public class RadioButtonGroupSD extends RadioButtonGroup {
	...
	public RadioButtonGroupSD(String displayName) {
	...
	public RadioButtonGroupSD addPlatformLocatorForNativeApp(PlatformType platform, LocateBy locateBy,
			String locatorValue) {
		LocatorUtil.setPlatformLocatorForNativeApp(platFormLocators, platform, locateBy, locatorValue);
		return this;
	}

	public RadioButtonGroupSD addPlatformLocatorForWebApp(PlatformType platform, WebBrowserType browserType,
	...
	@Override
	public RadioButtonGroupValidatorSD getValidator(SmartAppDriver appDriver, Region region) {
		return new RadioButtonGroupValidatorSD(appDriver, this, region);
	}

	@Override
	public RadioButtonGroupValidatorSD getValidator(SmartCucumberUiScenarioContext scenarioContext, Region region) {
	...
	public RadioButtonGroupSD updateLocatorParameterWithValue(String paramName,
		...
		return new RadioButtonGroupSD(newDisplayName, newPlatFormLocators);
	}
