...
public class HyperlinkSD extends Hyperlink {
	...
	public HyperlinkSD addPlatformLocatorForWebApp(PlatformType platform, WebBrowserType browserType, LocateBy locateBy,
			String locatorValue) {
	...
	@Override
	public HyperlinkValidatorSD getValidator(SmartCucumberUiScenarioContext scenarioContext, Region region) {
	...
	@Override
	public HyperlinkSD updateLocatorParameterWithValue(String paramName, String paramValue) {
