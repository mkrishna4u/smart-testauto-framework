...
import org.uitnet.testing.smartfwk.ui.core.objects.text.Text;
 ...
 *
 */
public class TextSD extends Text {
	protected Map<String, Locator> platFormLocators = new HashMap<>();

	public TextSD(String displayName) {
		super(LocatorType.DOM, displayName);
	}

	public TextSD(String displayName, Map<String, Locator> platFormLocators) {
		super(LocatorType.DOM, displayName);
		this.platFormLocators = platFormLocators;
	}

	public TextSD(String displayName, String xpath) {
		super(LocatorType.DOM, displayName);
		platFormLocators.put(SmartConstants.DEFAULT_XPATH_LOCATOR, new Locator(LocateBy.Xpath, xpath));
	}

	public TextSD addPlatformLocatorForNativeApp(PlatformType platform, LocateBy locateBy, String locatorValue) {
		LocatorUtil.setPlatformLocatorForNativeApp(platFormLocators, platform, locateBy, locatorValue);
		return this;
	}

	public TextSD addPlatformLocatorForWebApp(PlatformType platform, WebBrowserType browserType, LocateBy locateBy,
			String locatorValue) {
	...
	@Override
	public TextValidatorSD getValidator(SmartAppDriver appDriver, Region region) {
		return new TextValidatorSD(appDriver, this, region);
	}

	@Override
	public TextValidatorSD getValidator(SmartCucumberScenarioContext scenarioContext, Region region) {
	...
	@Override
	public TextSD updateLocatorParameterWithValue(String paramName, String paramValue) {
		...
		return new TextSD(newDisplayName, newPlatFormLocators);
	}
