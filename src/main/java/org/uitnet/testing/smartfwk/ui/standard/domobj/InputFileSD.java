...
import org.uitnet.testing.smartfwk.ui.core.objects.file.InputFile;
 ...
 *
 */
public class InputFileSD extends InputFile {
	protected Map<String, Locator> platFormLocators = new HashMap<>();

	public InputFileSD(String displayName) {
		super(LocatorType.DOM, displayName);
	}

	public InputFileSD(String displayName, Map<String, Locator> platFormLocators) {
		super(LocatorType.DOM, displayName);
		this.platFormLocators = platFormLocators;
	}

	public InputFileSD(String displayName, String xpath) {
		super(LocatorType.DOM, displayName);
		platFormLocators.put(SmartConstants.DEFAULT_XPATH_LOCATOR, new Locator(LocateBy.Xpath, xpath));
	}

	public InputFileSD addPlatformLocatorForNativeApp(PlatformType platform, LocateBy locateBy, String locatorValue) {
		LocatorUtil.setPlatformLocatorForNativeApp(platFormLocators, platform, locateBy, locatorValue);
		return this;
	}

	public InputFileSD addPlatformLocatorForWebApp(PlatformType platform, WebBrowserType browserType, LocateBy locateBy,
			String locatorValue) {
	...
	@Override
	public InputFileValidatorSD getValidator(SmartAppDriver appDriver, Region region) {
		return new InputFileValidatorSD(appDriver, this, region);
	}

	@Override
	public InputFileValidatorSD getValidator(SmartCucumberScenarioContext scenarioContext, Region region) {
	...
	@Override
	public InputFileSD updateLocatorParameterWithValue(String paramName, String paramValue) {
		...
		return new InputFileSD(newDisplayName, newPlatFormLocators);
	}
}
