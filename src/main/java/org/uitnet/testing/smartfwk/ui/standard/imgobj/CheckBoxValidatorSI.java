...
public class CheckBoxValidatorSI extends CheckBoxValidator {
	...
	@Override
	public CheckBoxValidatorSI scrollElementOnViewport(ScrollbarSI scrollbar) {
	...
	@Override
	public CheckBoxValidatorSI validateElementPresentWithinArea(AreaCoordinates coordinates,
		...
		if(!(match.x >= coordinates.getX1() && match.y >= coordinates.getY1() &&  
			...
			Assert.fail("Element '" + cbObject.getDisplayName() + "' is not within the specified area [x1=" + coordinates.getX1() 
