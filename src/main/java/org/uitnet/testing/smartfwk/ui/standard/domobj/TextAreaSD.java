...
public class TextAreaSD extends TextArea {
	...
	public TextAreaSD(String displayName) {
		super(LocatorType.DOM, displayName);
	}

	public TextAreaSD(String displayName, Map<String, Locator> platFormLocators) {
		super(LocatorType.DOM, displayName);
	...
	public TextAreaSD addPlatformLocatorForWebApp(PlatformType platform, WebBrowserType browserType, LocateBy locateBy,
			String locatorValue) {
	...
	@Override
	public TextAreaValidatorSD getValidator(SmartAppDriver appDriver, Region region) {
		return new TextAreaValidatorSD(appDriver, this, region);
	}

	@Override
	public TextAreaValidatorSD getValidator(SmartCucumberUiScenarioContext scenarioContext, Region region) {
	...
	@Override
	public TextAreaSD updateLocatorParameterWithValue(String paramName, String paramValue) {
		...
		return new TextAreaSD(newDisplayName, newPlatFormLocators);
	}
}
